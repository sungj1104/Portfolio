...
CREATE TABLE `aac_intakes` (
  `age_upon_intake` varchar(15) COLLATE utf8mb4_general_ci NOT NULL,
  ...
  `found_location` varchar(90) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `intake_condition` varchar(15) COLLATE utf8mb4_general_ci NOT NULL,
  `intake_type` varchar(25) COLLATE utf8mb4_general_ci NOT NULL,
  `name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `sex_upon_intake` varchar(20) COLLATE utf8mb4_general_ci NOT NULL
